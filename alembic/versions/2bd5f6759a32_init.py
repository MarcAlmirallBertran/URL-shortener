...
def upgrade() -> None:
    ...
    sa.Column('is_active', sa.BOOLEAN(), autoincrement=False, nullable=False, default=True),
    sa.Column('clicks', sa.INTEGER(), autoincrement=False, nullable=False, default=0),
